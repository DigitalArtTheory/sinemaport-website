...
const Roportaj = () => {
  return (
    <div className="max-w-[20.5rem] md:max-w-[71rem] mx-auto flex flex-col md:flex-row gap-[1rem]">
      <div className="flex flex-col gap-[0.75rem]">
        ...
        <div>
          ...
          <p className="text-white text-[0.625rem] font-light mt-[0.75rem]">
            ...
            başrolü üstlenmesiyle ivme kazandı, yönetmen koltuğunun “Lady Bird”
            ve “Little Women” filmleriyle kalbimizi kazanan Greta Gerwig’e
            emanet edilmesiyle ise yüksek bir beklenti oluşturdu. “Barbie”,
            temelinde bir "ürün filmi", ancak Gerwig’in ve senaryoyu birlikte
            kaleme aldığı Noah Baumbach’ın sayesinde film, iki saatlik bir
            oyuncak reklamı olmanın ötesine geçmeyi başarıyor.
          </p>
        </div>
